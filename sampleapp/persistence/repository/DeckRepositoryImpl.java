    ...
    public List<?> selectDeck(String username, String format) {
        ...
        try {
            ...
            if ("plain".equals(format)) {
                ...
                return cards.stream().map(card -> card.get("Name").toString() + ", Damage: " + card.get("Damage").toString()).collect(Collectors.toList());
            } else {
...
//    public static void main(String[] args) {
//        // Create an instance of DeckRepositoryImpl
//        DeckRepositoryImpl deckRepository = new DeckRepositoryImpl(new UnitOfWork());
//
//        // Replace "testUser" with the actual username you want to check
//        String usernameToCheck = "kienboec";
//
//        // Use the provided array of card IDs
//        List<String> cardIdsToCheck = Arrays.asList(
...
//        );
//
//        boolean userOwnsCards = deckRepository.checkUserOwnsCards(usernameToCheck, cardIdsToCheck);
//
//        if (userOwnsCards) {
//            System.out.println("User owns the specified cards.");
//        } else {
//            System.out.println("User does not own the specified cards.");
//        }
//    }
